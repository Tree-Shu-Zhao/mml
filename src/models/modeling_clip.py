...
class CLIPVisionEmbeddings(nn.Module):
    ...
    def forward(self, pixel_values, text_features=None):
        ...
        if text_features is not None:
            embeddings = torch.cat([class_embeds, text_features, patch_embeds[:, :-1, :]], dim=1)
        else:
...
class CLIPTextEmbeddings(nn.Module):
    ...
    def forward(self, input_ids=None, position_ids=None, inputs_embeds=None, image_features=None):
...
class CLIPTextTransformer(nn.Module):
    ...
    def forward(
        ...
        hidden_states = self.embeddings(input_ids=input_ids, position_ids=position_ids, image_features=image_features)
        ...
        if image_features is not None:
            pooled_output = last_hidden_state[torch.arange(last_hidden_state.shape[0]), input_ids.argmax(dim=-1)+1]
        else:
...
class CLIPVisionTransformer(nn.Module):
    ...
    def forward(
        ...
        hidden_states = self.embeddings(pixel_values, text_features=text_features)
